...
<div id="content_area">
<div class="title_bar title_name">Add Department</div>
	<form id="addDepartmentform" name="addDepartmentform" method="post" action="/manageGlobalObject?action=add&type=department">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr>
      ...
      <td class="form_underline" width="354" height="120">
        <input name="departmentName" type="text" class="textfield_style" id="departmentName">
        </td>
