...
<div id="content_area">
  ...
  <tr>
    <td height="50" valign="middle">Sensor List</td>
    </tr>
</table>
  </div>
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="20%" height="40" align="left" valign="middle" class="listTitle_CSS form_underline_blue radiusRight">Detail</td>
      </tr>
      <%
      ...
      %>
	      ...
	      <td height="30" align="left" class="font_18 form_underline_gray"><a href="listSensorData.jsp?k=<%= KeyFactory.keyToString(storageDevice.getKey()) %>&period=day"><img src="../images/thermograph.png" width="28" height="26" title="View Humi&Temp"></a>
	      <% 
