...
<div id="content_area">
  ...
  <td width="5%" height="50" valign="middle"><a href="listStorage.jsp"><img src="../images/backicon.png" alt="" width="28" height="28" class="editList_backicon_position"></a></td>
    <td width="65%" height="50"><%= storageItem.getStorageItemName() %> (<%= storageDevice.getStorageDeviceSerialNumber() %> → <%= "Door " + deviceModelDoor.getDeviceModelDoorNumber() %> → <%= deviceModelPartition.getDeviceModelPartitionName() %>)</td>
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="40" align="center" class="listTitle_CSS form_underline_blue radiusLeft">Item Instance</td>
      <td width="15%" align="center" class="listTitle_CSS form_underline_blue ">Operator</td>
      <td width="20%" align="center" class="listTitle_CSS form_underline_blue ">Date</td>
      <td width="15%" height="40" align="center" class="listTitle_CSS form_underline_blue radiusRight">Remove</td>
      <td width="15%" align="center" class="listTitle_CSS form_underline_blue radiusRight">History</td>
    </tr>
    ...
    %>
	    <tr class="listCotent_CSS">
	      <td height="30" align="center" class="font_18 form_underline_gray"><%= storageItemInstance.getStorageItemInstanceSerialNumber() %></td>
	      <td width="15%" height="30" align="center" class="font_18 form_underline_gray"><%= customerUser.getCustomerUserName() %></td>
          ...
          <td width="15%" align="center" class="font_18 form_underline_gray"><a href="listItemInstanceTrans.jsp?k=<%= KeyFactory.keyToString(storageItemInstance.getKey()) %>" title="history"><img style="margin-top:3px;" src="../images/history.png" width="24" height="24"></a></td>
