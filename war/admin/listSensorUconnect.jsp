  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      %>
	      ...
	      <td height="30" align="center" class="font_18 form_underline_gray"><a href="listSensorDataUconnect.jsp?k=<%= KeyFactory.keyToString(storageDevice.getKey()) %>&period=day"><img src="../images/thermograph.png" width="28" height="26" title="View Humi&Temp"></a>
	      </td>
	      </tr>
	  <%
      }
