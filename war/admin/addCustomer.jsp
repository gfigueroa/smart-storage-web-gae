...
<div id="content_area">
<div class="title_bar title_name">Add a new <span class="form_underline">customer</span></div>
...
<!--"/manageUser?action=add&type=customer&keep_adding=true">-->
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr>
      ...
      <td width="303" height="50" align="left"><div id="empty_customerName" class="errorText">*Enter companyr name</div></td>
    </tr>
    <tr>
      <td width="130" height="50" align="right" scope="row">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="354" height="50">
        <input name="customerComments" type="text" class="textfield_style" id="customerComments"></td>
      <td width="303" height="50" align="left">&nbsp;</td>
    </tr>
    ...
    <tr><td colspan="4" align="center"><input type="submit" name="NewCustomerSubmit" id="NewCustomerSubmit" class="css_btn_class" value="Save">&nbsp;<input type="button" name="buttonClose" id="buttonClose" class="css_btn_class" onclick="window.location.href='listCustomer.jsp'" value="Close"></td>
      </tr>
</table>
  </form>
</div>
