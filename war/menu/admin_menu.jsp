...
<div id="main_list">
      <div class="main_list_font_size" id="main_list_1"><a href="../admin/listAdmin.jsp" class="main_list_font_size">Administrator</a></div>
      ...
      <div class="main_list_font_size" id="main_list_4">Storage<br/>item</div>
      <div class="main_list_font_size" id="main_list_5">Alarm<br/>warning</div>
      <div class="main_list_font_size" id="main_list_6">Marketing</div>
      <div class="main_list_font_size" id="main_list_7">Configuration</div>
...
<div id="main_list_7_content">
  <div id="main_list_7_area"><table width="100%" height="120" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
        <td height="40" align="left" class="font_18 form_underline">&nbsp;<a href="../admin/listCountry.jsp" class="font_18">Country</a></td>
      </tr>
      <tr>
        <td height="40" align="left" class="font_18 form_underline"> &nbsp;<a href="../admin/listRegion.jsp" class="font_18">Region</a></td>
      </tr>      
      <tr>
        <td height="40" align="left" class="font_18 form_underline">&nbsp;<a class="font_18" href="listDepartment.jsp">Department</a></td>
      </tr>
  </table></div>
</div>
